...
export default function PrefBackends() {
  ...
  return (
    <>
      <Setting
        title='Бэкэнд'
        description='Управляет бэкендом, используемым для получения сообщений. Этот параметр можно изменить, чтобы использовать пользовательский бэкенд.'
      >
        ...
        <>
          ...
          {customBackendStatus !== undefined && (
            <Message>
              ...
              {customBackendStatus ? 'Успешно!' : 'Не удается связаться с пользовательским бэкендом.'}
            </Message>
          )}
        </>
      )}
